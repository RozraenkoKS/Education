...
public:
    ...
    [[nodiscard]] virtual  std::shared_ptr<Computer> clone() const = 0; // note: virtual copy
...
public:
    ...
    [[nodiscard]] std::shared_ptr<Computer> clone() const override
    {
        return std::make_shared<Mobile>(*this); // note: delete required
    }
...
public:
    ...
    [[nodiscard]] std::shared_ptr<Computer> clone() const override
    {
        return std::make_shared<Tablet>(*this); // note: delete required
    }
...
public:
    ...
    [[nodiscard]] std::shared_ptr<Computer> clone() const override
    {
        return std::make_shared<Laptop>(*this); // note: delete required
    }
...
int main()
{
    ...
    mobile->run();  // good: no memory leak
